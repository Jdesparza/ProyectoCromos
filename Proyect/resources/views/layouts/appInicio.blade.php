...
<body>
    ...
    <nav class="menuPrincipalIniciando">
        <div class="menuPrincipal1">
            <a href="{{ route('welcome') }}" class="menu1">
                <img src="../../img/casa 1.png" alt="">
                Inicio
            </a>
            <a href="{{ route('login') }}" class="menu1">
        ...
        <div class="menuPrincipal2">
            <a class="menuPrincipal2_1" href="{{ route('login') }}">Login </a>
            <a class="menuPrincipal2_2" href="{{ route('register') }}">Register</a>
        </div>
    </nav>
    <div>
        @yield('content')
